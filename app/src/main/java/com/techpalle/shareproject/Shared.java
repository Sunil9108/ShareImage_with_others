...
public class Shared extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedImageView =  findViewById(R.id.shared_imageview);
        sharedTextView =  findViewById(R.id.shared_textview);
        shared_textview_title =  findViewById(R.id.shared_textview_title);
        shared_imageview_title = findViewById(R.id.shared_imageview_title);
    ...
    private void onSharedIntent() {
        ...
        if (receivedAction.equals(Intent.ACTION_SEND)) {
            ...
            // If mime type is equal to image then show image and hide textview
                ...
                if (receiveUri != null) {
                    try {
                        Bitmap bitmap = Utils.decodeUri(Shared.this,
                                receiveUri, 200);
